...
<template>
  <ArHBox gap="4px" justify="flex-end" align="center">
    ...
    <!-- 预览切换 -->
    <ArButton size="sm" type="ghost" @click="emit('togglePreview')" :title="preview ? '返回编辑' : '预览段落'">
      <template #icon>
    ...
    <ArButton size="sm" type="ghost" :disabled="!canMoveUp" @click="emit('moveUp')" title="上移"> ↑ </ArButton>
